    ...
    <nav class="navbar navbar-expand-lg navbar-dark py-3" style="background: transparent;">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
            <div class="navbar-nav ml-auto p-4" style="background: transparent;">
                ...
                <a href="admin/admin.signin.php"><i class=" nav-item nav-link fa fa-fw fa-user"></i> </a>
            </div>
        </div>
    </nav>
</div>
        ...
        <div id="blog-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" style="height: 1116px; width: 1366px;" src="img/anndgymcarouselzz.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        ...
                        <a href="signin.php" class="btn btn-lg btn-outline-light mt-3 mt-md-5 py-md-3 px-md-5">Join Us Now</a>
                    </div>
                </div>
