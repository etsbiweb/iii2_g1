...
<body class="bg-white">
    ...
    <div class="container-fluid page-header mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style="min-height: 400px">
            <h4 class="display-4 mb-3 mt-0 mt-lg-5 text-white text-uppercase font-weight-bold">WHEY</h4>
    ...
    <div class="container pt-5 team">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                <div class="card border-0 bg-secondary text-center text-white">
                    <img class="card-img-top" src="slikeproducts/wheyvanila.jpg" alt="">
                    <div class="card-social d-flex align-items-center justify-content-center">
                      
                    </div>
                    <div class="card-body bg-white">
                        <h4 class="card-title text-primary">WHEY COOKIE</h4>
                ...
                <div class="col-lg-3 col-md-6 mb-5">
                    <div class="card border-0 bg-secondary text-center text-white">
                        <img class="card-img-top" src="slikeproducts/wheyoreo.jpg" alt="">
                        <div class="card-social d-flex align-items-center justify-content-center">
                        
                        </div>
                        <div class="card-body bg-white">
                            <h4 class="card-title text-primary">WHEY OREO</h4>
                ...
                <div class="col-lg-3 col-md-6 mb-5">
                    <div class="card border-0 bg-secondary text-center text-white">
                        ...
                        <div class="card-body bg-white">
                            <h4 class="card-title text-primary">WHEY VANILLA</h4>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 mb-5">
                <div class="card border-0 bg-secondary text-center text-white">
                    <img class="card-img-top" src="slikeproducts/wheypro.jpeg" alt="">
                    <div class="card-social d-flex align-items-center justify-content-center">
                      
                    </div>
                    <div class="card-body bg-white">
                        <h4 class="card-title text-primary">WHEY PRO</h4>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                <div class="card border-0 bg-secondary text-center text-white">
                    <img class="card-img-top" src="slikeproducts/breskva.jpg" alt="">
                    <div class="card-social d-flex align-items-center justify-content-center">
                      
                    </div>
                    <div class="card-body bg-white">
                        <h4 class="card-title text-primary">WHEY PEACH</h4>
                ...
                <div class="col-lg-3 col-md-6 mb-5">
                    <div class="card border-0 bg-secondary text-center text-white">
                        <img class="card-img-top" src="slikeproducts/cokolada.jpeg" alt="">
                        <div class="card-social d-flex align-items-center justify-content-center">
                        
                        </div>
                        <div class="card-body bg-white">
                            <h4 class="card-title text-primary">WHEY CHOCO</h4>
                ...
                <div class="col-lg-3 col-md-6 mb-5">
                    <div class="card border-0 bg-secondary text-center text-white">
                        ...
                        <div class="card-body bg-white">
                            <h4 class="card-title text-primary">WHEY VANILA </h4>
